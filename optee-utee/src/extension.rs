...
impl LoadablePlugin {
    ...
    pub fn invoke_with_capacity<'a>(
        ...
        self.new_command_with_capacity(command_id, capacity)
            .sub_cmd(subcommand_id)
    }
    ...
    pub fn new_command_with_capacity<'a>(
        ...
        LoadablePluginCommand::new_with_capacity(self, command_id, capacity)
    }
}
...
impl<'a> LoadablePluginCommand<'a> {
    fn new_with_capacity(plugin: &'a LoadablePlugin, cmd_id: u32, capacity: usize) -> Self {
        Self {
            plugin,
            cmd_id,
            sub_cmd_id: 0,
